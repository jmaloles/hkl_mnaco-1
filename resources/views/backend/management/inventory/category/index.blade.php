...
<h1>
   ...
   <small>{{ trans('labels.backend.management.inventory.category.all') }}</small>
</h1>
@endsection
...
<div class="box box-success">
   <div class="box-header with-border">
      <h3 class="box-title">{{ trans('labels.backend.management.inventory.category.all') }}</h3>
         ...
         <table id="categories-table" class="table table-condensed table-hover">
            <thead>
               <tr>
                  ...
                  <th>{{ trans('labels.backend.management.inventory.category.table.number_of_assets') }}</th>
...
$(function () {
   $('#categories-table').DataTable({
      ...
      columns: [
         ...
         {data: 'number_of_assets',  name: 'asset_count'},
